...
Если это станет мешать — вариант: маленькое расширение-компаньон в `~/.pi/agent/extensions/`, которое дорисовывает поверх. Форк `pi-claude-code-ui` не рассматривается: 7.5k строк, апдейты теряются.
